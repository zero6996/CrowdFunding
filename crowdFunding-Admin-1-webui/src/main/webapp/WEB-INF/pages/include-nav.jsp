...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="/admin/to/main/page.html">众筹平台 - 控制面板</a></div>
        </div>
                ...
                <li style="padding-top:8px;">
                    <div class="btn-group">
                        <button type="button" class="btn btn-default btn-success dropdown-toggle" data-toggle="dropdown">
                            <!-- 使用SpringSecurity提供的JSP标签获取已登录用户的用户名 -->
<%--                            <i class="glyphicon glyphicon-user"></i><security:authentication property="name"/><span class="caret"></span>--%>
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="divider"></li>
                            <li><a href="admin/security/do/logout.html"><i class="glyphicon glyphicon-off"></i> 退出系统</a></li>
                        </ul>
                    </div>
                </li>
